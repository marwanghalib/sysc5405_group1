...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 25 11:47:50 2021

@author: PalwashaW_Shaikh
"""


#GRU RNN with Regression
...
plt.savefig("REGRESSION_anova_gru_rnn.png")
plt.clf()
...
simp_rnn.add(GRU(units=256, return_sequences = True, input_shape = (x_training_data.shape[1], 1)))
simp_rnn.add(Dropout(0.2))
simp_rnn.add(GRU(units=256, return_sequences = True))
simp_rnn.add(Dropout(0.2))
simp_rnn.add(GRU(units=256, return_sequences = True))
simp_rnn.add(Dropout(0.2))
simp_rnn.add(GRU(units=256, return_sequences = False))
simp_rnn.add(Dropout(0.2))
#Output Layer 
...
plt.legend()
plt.savefig("REGRESSION_loss_gru_rnn.png")
...
plt.savefig("REGRESSION_dti_gru_rnn.png")
...
plt.savefig("REGRESSION_box_plot_of_errors_gru_rnn.png")
